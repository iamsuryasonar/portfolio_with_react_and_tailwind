        ...
        <div className="flex flex-col items-center gap-4 p-4 bg-white rounded-lg shadow-lg md:grid md:grid-cols-5 "  >
            ...
            <div className="h-full p-8 col-span-2 flex flex-col justify-evenly items-center gap-6">
                ...
                <div className="grid grid-cols-4 gap-6">
                    {icons.map((item) => {
                        return <button className='w-10 h-10 aspect-square rounded-full bg-white shadow-md'><FontAwesomeIcon icon={item.icon} /></button>
                    })}
                </div>
    ...
    return <>
        <section id='projects' className="py-24 min-h-svh w-full bg-slate-50 flex flex-col items-center gap-16 ">
            <div className="max-w-4xl flex flex-col items-center">
                <p className="uppercase font-bold text-blue-500 text-2xl">Projects</p>
                <p className="text-xl font-bold text-center">{text.project_quote}</p>
            </div>
            {projects.map((item) => {
